...
public final class FixTimestamp implements Resettable {
    ...
    public void parseTimeBuffer(
            final ByteBuffer buffer, final int offset, final int length, final FixTimestampPrecision precision) {
    ...
    public void parseTimestampBuffer(
            final ByteBuffer buffer, final int offset, final int length, final FixTimestampPrecision precision) {
        this.precision = precision;
        reset();
    ...
    private void parseTimeInternal(
            final ByteBuffer buffer, int offset, int length, final FixTimestampPrecision precision) {
        // HH:MM:ss[.sss][sss]
        // 01234567 8901  234
