...
public final class InboundJsonWebSocketWriter extends InboundWebSocketWriter {
    ...
    public InboundJsonWebSocketWriter(WebSocketClient socketClient, JsonEncoder jsonEncoder) {
        super(socketClient);
