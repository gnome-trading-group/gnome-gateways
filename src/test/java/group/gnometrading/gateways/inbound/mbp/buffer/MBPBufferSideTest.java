...
class MbpBufferSideTest {
    ...
    void testUpdateFromEmptySchema() {
        ...
        setAllBidLevels(
                ...
                Mbp10Encoder.bidSize0NullValue(),
                Mbp10Encoder.bidCount0NullValue());
    ...
    private long getBidCount(Mbp10Schema schema, int level) {
        switch (level) {
            case 0:
                return schema.decoder.bidCount0();
            case 1:
                return schema.decoder.bidCount1();
            case 2:
                return schema.decoder.bidCount2();
            case 3:
                return schema.decoder.bidCount3();
            case 4:
                return schema.decoder.bidCount4();
            case 5:
                return schema.decoder.bidCount5();
            case 6:
                return schema.decoder.bidCount6();
            case 7:
                return schema.decoder.bidCount7();
            case 8:
                return schema.decoder.bidCount8();
            case 9:
                return schema.decoder.bidCount9();
            default:
                throw new IllegalArgumentException("Invalid level: " + level);
        }
    }
    ...
    private long getAskCount(Mbp10Schema schema, int level) {
        switch (level) {
            case 0:
                return schema.decoder.askCount0();
            case 1:
                return schema.decoder.askCount1();
            case 2:
                return schema.decoder.askCount2();
            case 3:
                return schema.decoder.askCount3();
            case 4:
                return schema.decoder.askCount4();
            case 5:
                return schema.decoder.askCount5();
            case 6:
                return schema.decoder.askCount6();
            case 7:
                return schema.decoder.askCount7();
            case 8:
                return schema.decoder.askCount8();
            case 9:
                return schema.decoder.askCount9();
            default:
                throw new IllegalArgumentException("Invalid level: " + level);
        }
    }
