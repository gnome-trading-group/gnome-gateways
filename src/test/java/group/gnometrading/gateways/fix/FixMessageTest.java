...
class FixMessageTest {
    ...
    private static Stream<Arguments> testParseBufferResultArguments() {
        return Stream.of(
                ...
                Arguments.of(
                        fix("x8=FIX.5.2|9=14|35=A|18=hello|10=015|other stuff on the wire")
                                .position(1),
                        true,
                        37),
                Arguments.of(
                        fix("x9=FIX.5.2|9=14|35=A|18=hello|10=015|other stuff on the wire")
                                .position(1),
                        false,
                        1));
    }
    ...
    private static Stream<Arguments> testMessageTagsArguments() {
        return Stream.of(
                ...
                Arguments.of(
                        fix("8=FIX.5.2|9=14|35=A|18=hello|10=015|other stuff on the wire"),
                        Map.of(35, "A", 18, "hello")));
    }
    ...
    void testMessageTags(ByteBuffer buffer, Map<Integer, String> tags) {
        ...
        for (var item : tags.entrySet()) {
            assertEquals(
                    item.getValue(), message.getTag(item.getKey()).asString().toString());
        }
    }
    ...
    private static Stream<Arguments> testWriteBufferArguments() {
        return Stream.of(
                ...
                Arguments.of(
                        new FixConfig.Builder()
                                .withSessionVersion(FixVersion.FIX_4_3)
                                .build(),
                        (Consumer<FixMessage>) message -> {},
