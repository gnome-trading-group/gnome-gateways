...
class FixValueTest {
    ...
    private static Stream<Arguments> testParseBufferArguments() {
        return Stream.of(
                ...
                Arguments.of(
                        ByteBuffer.wrap("111111|123".getBytes()).position(2).put(6, (byte) 1), true, 4, 2));
    }
    ...
    private static Stream<Arguments> testTimeArguments() {
        return Stream.of(
                ...
                Arguments.of(
                        ByteBuffer.wrap("xx11:15:00.123456".getBytes()).position(2), MICROSECONDS, "11:15:00.123456"));
    }
    ...
    private static Stream<Arguments> testTimestampArguments() {
        return Stream.of(
                ...
                Arguments.of(
                        ByteBuffer.wrap("xxx20221231-12:45:00.123".getBytes()).position(3),
                        SECONDS,
                        "20221231-12:45:00"),
                Arguments.of(
                        ByteBuffer.wrap("20221231-12:45:00.123".getBytes()), MILLISECONDS, "20221231-12:45:00.123"),
                ...
                Arguments.of(
                        ByteBuffer.wrap("20241231-11:15:00.123456".getBytes()),
                        MICROSECONDS,
                        "20241231-11:15:00.123456"),
                Arguments.of(
                        ByteBuffer.wrap("xx20241231-11:15:00.123456".getBytes()).position(2),
                        MICROSECONDS,
                        "20241231-11:15:00.123456"));
    }
    ...
    private static Stream<Arguments> testWriteBufferArguments() {
        return Stream.of(
                ...
                Arguments.of(
                        (Consumer<FixValue>) (value) -> value.setDecimal(-995678.5604, 4), fix("-995678.5604|"), 13),
                Arguments.of((Consumer<FixValue>) (value) -> value.setCheckSum(13543215), fix("047|"), 4),
                Arguments.of(
                        (Consumer<FixValue>) (value) -> value.setTimestamp(1L, MILLISECONDS),
                        fix("19700101-00:00:00.001|"),
                        22),
                Arguments.of(
                        (Consumer<FixValue>) (value) -> {
